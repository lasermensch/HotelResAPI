        ...
        public static void Initialize(HotelResDbContext context)
        {
            ...
            if (!context.Hotels.Any())
            {
                Hotel[] hotels =
                {
                    ...
                    new Hotel {HotelId = Guid.NewGuid(), HotelName="The Proletarian", Adress="Peoples Street 95, MarxCity", PhoneNr="+378555849587", Email="theproletarian@hotels.test", WebPage="theproletarianhotel.test", NrOfVotes=67, Rating=3.1,},
                };
            ...
            if (!context.Rooms.Any())
            {
                Room[] rooms =
                {
                    new Room{RoomId=Guid.NewGuid(), HotelId=context.Hotels.AsEnumerable<Hotel>().ElementAt(0).HotelId, Price=5000, Size=0},
                    new Room{RoomId=Guid.NewGuid(), HotelId=context.Hotels.AsEnumerable<Hotel>().ElementAt(0).HotelId, Price=5000, Size=0},
                    new Room{RoomId=Guid.NewGuid(), HotelId=context.Hotels.AsEnumerable<Hotel>().ElementAt(0).HotelId, Price=5000, Size=0},
                    new Room{RoomId=Guid.NewGuid(), HotelId=context.Hotels.AsEnumerable<Hotel>().ElementAt(0).HotelId, Price=5000, Size=0},
                    new Room{RoomId=Guid.NewGuid(), HotelId=context.Hotels.AsEnumerable<Hotel>().ElementAt(0).HotelId, Price=5000, Size=1},
                    new Room{RoomId=Guid.NewGuid(), HotelId=context.Hotels.AsEnumerable<Hotel>().ElementAt(0).HotelId, Price=5000, Size=1},
                    new Room{RoomId=Guid.NewGuid(), HotelId=context.Hotels.AsEnumerable<Hotel>().ElementAt(0).HotelId, Price=5000, Size=1},
                    new Room{RoomId=Guid.NewGuid(), HotelId=context.Hotels.AsEnumerable<Hotel>().ElementAt(0).HotelId, Price=5000, Size=2},
                    new Room{RoomId=Guid.NewGuid(), HotelId=context.Hotels.AsEnumerable<Hotel>().ElementAt(0).HotelId, Price=5000, Size=2},
                    new Room{RoomId=Guid.NewGuid(), HotelId=context.Hotels.AsEnumerable<Hotel>().ElementAt(0).HotelId, Price=5000, Size=2},
                    new Room{RoomId=Guid.NewGuid(), HotelId=context.Hotels.AsEnumerable<Hotel>().ElementAt(0).HotelId, Price=5000, Size=2},
                    ...
                    new Room{RoomId=Guid.NewGuid(), HotelId=context.Hotels.AsEnumerable<Hotel>().ElementAt(1).HotelId, Price=5000, Size=0},
                    new Room{RoomId=Guid.NewGuid(), HotelId=context.Hotels.AsEnumerable<Hotel>().ElementAt(1).HotelId, Price=5000, Size=0},
                    new Room{RoomId=Guid.NewGuid(), HotelId=context.Hotels.AsEnumerable<Hotel>().ElementAt(1).HotelId, Price=5000, Size=1},
                    new Room{RoomId=Guid.NewGuid(), HotelId=context.Hotels.AsEnumerable<Hotel>().ElementAt(1).HotelId, Price=5000, Size=1},
                    new Room{RoomId=Guid.NewGuid(), HotelId=context.Hotels.AsEnumerable<Hotel>().ElementAt(1).HotelId, Price=5000, Size=1},
                    new Room{RoomId=Guid.NewGuid(), HotelId=context.Hotels.AsEnumerable<Hotel>().ElementAt(1).HotelId, Price=5000, Size=2},
                    new Room{RoomId=Guid.NewGuid(), HotelId=context.Hotels.AsEnumerable<Hotel>().ElementAt(1).HotelId, Price=5000, Size=2},
                    new Room{RoomId=Guid.NewGuid(), HotelId=context.Hotels.AsEnumerable<Hotel>().ElementAt(1).HotelId, Price=5000, Size=2},
                    new Room{RoomId=Guid.NewGuid(), HotelId=context.Hotels.AsEnumerable<Hotel>().ElementAt(1).HotelId, Price=5000, Size=2},

                    new Room{RoomId=Guid.NewGuid(), HotelId=context.Hotels.AsEnumerable<Hotel>().ElementAt(2).HotelId, Price=5000, Size=0},
                    new Room{RoomId=Guid.NewGuid(), HotelId=context.Hotels.AsEnumerable<Hotel>().ElementAt(2).HotelId, Price=5000, Size=0},
                    new Room{RoomId=Guid.NewGuid(), HotelId=context.Hotels.AsEnumerable<Hotel>().ElementAt(2).HotelId, Price=5000, Size=0},
                    new Room{RoomId=Guid.NewGuid(), HotelId=context.Hotels.AsEnumerable<Hotel>().ElementAt(2).HotelId, Price=5000, Size=0},
                    new Room{RoomId=Guid.NewGuid(), HotelId=context.Hotels.AsEnumerable<Hotel>().ElementAt(2).HotelId, Price=5000, Size=1},
                    new Room{RoomId=Guid.NewGuid(), HotelId=context.Hotels.AsEnumerable<Hotel>().ElementAt(2).HotelId, Price=5000, Size=1},
                    new Room{RoomId=Guid.NewGuid(), HotelId=context.Hotels.AsEnumerable<Hotel>().ElementAt(2).HotelId, Price=5000, Size=1},
                    new Room{RoomId=Guid.NewGuid(), HotelId=context.Hotels.AsEnumerable<Hotel>().ElementAt(2).HotelId, Price=5000, Size=1},
                    new Room{RoomId=Guid.NewGuid(), HotelId=context.Hotels.AsEnumerable<Hotel>().ElementAt(2).HotelId, Price=5000, Size=1},
                    new Room{RoomId=Guid.NewGuid(), HotelId=context.Hotels.AsEnumerable<Hotel>().ElementAt(2).HotelId, Price=5000, Size=1},
                    new Room{RoomId=Guid.NewGuid(), HotelId=context.Hotels.AsEnumerable<Hotel>().ElementAt(2).HotelId, Price=5000, Size=2},
                    new Room{RoomId=Guid.NewGuid(), HotelId=context.Hotels.AsEnumerable<Hotel>().ElementAt(2).HotelId, Price=5000, Size=2},

                    new Room{RoomId=Guid.NewGuid(), HotelId=context.Hotels.AsEnumerable<Hotel>().ElementAt(3).HotelId, Price=5000, Size=0},
                    new Room{RoomId=Guid.NewGuid(), HotelId=context.Hotels.AsEnumerable<Hotel>().ElementAt(3).HotelId, Price=5000, Size=0},
                    new Room{RoomId=Guid.NewGuid(), HotelId=context.Hotels.AsEnumerable<Hotel>().ElementAt(3).HotelId, Price=5000, Size=0},
                    new Room{RoomId=Guid.NewGuid(), HotelId=context.Hotels.AsEnumerable<Hotel>().ElementAt(3).HotelId, Price=5000, Size=0},
                    new Room{RoomId=Guid.NewGuid(), HotelId=context.Hotels.AsEnumerable<Hotel>().ElementAt(3).HotelId, Price=5000, Size=0},
                    new Room{RoomId=Guid.NewGuid(), HotelId=context.Hotels.AsEnumerable<Hotel>().ElementAt(3).HotelId, Price=5000, Size=0},
                    new Room{RoomId=Guid.NewGuid(), HotelId=context.Hotels.AsEnumerable<Hotel>().ElementAt(3).HotelId, Price=5000, Size=1},
                    new Room{RoomId=Guid.NewGuid(), HotelId=context.Hotels.AsEnumerable<Hotel>().ElementAt(3).HotelId, Price=5000, Size=1},
                    new Room{RoomId=Guid.NewGuid(), HotelId=context.Hotels.AsEnumerable<Hotel>().ElementAt(3).HotelId, Price=5000, Size=1},
                    new Room{RoomId=Guid.NewGuid(), HotelId=context.Hotels.AsEnumerable<Hotel>().ElementAt(3).HotelId, Price=5000, Size=1},
                    new Room{RoomId=Guid.NewGuid(), HotelId=context.Hotels.AsEnumerable<Hotel>().ElementAt(3).HotelId, Price=5000, Size=1},
